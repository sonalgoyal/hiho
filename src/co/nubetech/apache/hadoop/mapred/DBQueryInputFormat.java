...
public class DBQueryInputFormat extends
	...
	final static Logger logger = Logger
			.getLogger(co.nubetech.apache.hadoop.mapred.DBQueryInputFormat.class);
	 ...
	 */
	public static void setInput(JobConf job, String inputQuery,
		...
		if (inputBoundingQuery != null) {
			job.set(DBConfiguration.INPUT_BOUNDING_QUERY,
					inputBoundingQuery);
		}
		if (params != null) {
			DefaultStringifier<ArrayList> stringifier = new DefaultStringifier<ArrayList>(
					job, ArrayList.class);
			job.set(HIHOConf.QUERY_PARAMS,
					stringifier.toString(params));
			logger.debug("Converted params and saved them into config");
		}
