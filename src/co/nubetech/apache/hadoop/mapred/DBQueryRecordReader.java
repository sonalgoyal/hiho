...
public class DBQueryRecordReader extends
	...
	public DBQueryRecordReader(org.apache.hadoop.mapreduce.lib.db.DBInputFormat.DBInputSplit split,
	...
	/**
	   ...
	   */
	  @Deprecated
	  public boolean next(LongWritable key, GenericDBWritable value) throws IOException {
	    this.key = key;
	    this.value = value;
	    return nextKeyValue();
	  }
