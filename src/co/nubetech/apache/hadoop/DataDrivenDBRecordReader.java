...
public class DataDrivenDBRecordReader<T extends DBWritable> extends
		DBRecordReader<T> {

	private static final Log LOG = LogFactory
			.getLog(DataDrivenDBRecordReader.class);
	...
	public DataDrivenDBRecordReader(DBInputFormat.DBInputSplit split,
			...
			String table, String dbProduct) throws SQLException {
