...
public class FTPTextOutputFormat<K, V> extends TextOutputFormat<K, V> {
	...
	protected static class FTPLineRecordWriter<K, V>
    ...
    public FTPLineRecordWriter(DataOutputStream out, String keyValueSeparator, FTPClient ftpClient) {
    ...
    if (!isCompressed) {
      //FSDataOutputStream fileOut = fs.create(file, false);
		...
		return new FTPLineRecordWriter<K, V>(fileOut, keyValueSeparator, f);
